# Generated by Django 4.2.2 on 2023-07-07 14:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neet_score_card', models.FileField(null=True, upload_to='files/')),
                ('conduct_certificate', models.FileField(null=True, upload_to='files/')),
                ('neet_admit_card', models.FileField(null=True, upload_to='files/')),
                ('allotment_order_sslc_certificate', models.FileField(null=True, upload_to='files/')),
                ('hsc_certificate', models.FileField(null=True, upload_to='files/')),
                ('transfer_certificate', models.FileField(null=True, upload_to='files/')),
                ('community_certificate', models.FileField(null=True, upload_to='files/')),
                ('aadhar_card', models.FileField(null=True, upload_to='files/')),
                ('eligibility_migration_certificates', models.FileField(null=True, upload_to='files/')),
                ('nativity_certificate', models.FileField(null=True, upload_to='files/')),
                ('income_certificate', models.FileField(null=True, upload_to='files/')),
                ('physical_fitness_certificate', models.FileField(null=True, upload_to='files/')),
                ('declaration_form', models.FileField(null=True, upload_to='files/')),
                ('anti_ragging_bond', models.FileField(null=True, upload_to='files/')),
                ('physically_handicapped_certificate', models.FileField(null=True, upload_to='files/')),
            ],
        ),
    ]
